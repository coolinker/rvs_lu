...
.field private static a:Lcom/tendcloud/tenddata/aa;
...
.method private static declared-synchronized a(Landroid/content/Context;)V
    ...
    sput-object v0, Lcom/tendcloud/tenddata/e;->c:Landroid/content/Context;

    sget-object v0, Lcom/tendcloud/tenddata/TCAgent;->a:Lcom/tendcloud/tenddata/aa;
    ...
    sput-object v0, Lcom/tendcloud/tenddata/TCAgent;->a:Lcom/tendcloud/tenddata/aa;
    :try_end_16
...
.method public static declared-synchronized getDeviceId(Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-interface {v0, p0}, Lcom/tendcloud/tenddata/aa;->b(Landroid/content/Context;)Ljava/lang/String;
    :try_end_b
...
.method public static declared-synchronized init(Landroid/content/Context;)V
    ...
    invoke-interface {v0, p0}, Lcom/tendcloud/tenddata/aa;->a(Landroid/content/Context;)V
    :try_end_b
...
.method public static declared-synchronized init(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-interface {v0, p0, p1, p2}, Lcom/tendcloud/tenddata/aa;->a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)V
    :try_end_b
    .catch Ljava/lang/Throwable; {:try_start_3 .. :try_end_b} :catch_d
    .catchall {:try_start_3 .. :try_end_b} :catchall_12
...
.method public static onError(Landroid/content/Context;Ljava/lang/Throwable;)V
    ...
    invoke-interface {v0, p0, p1}, Lcom/tendcloud/tenddata/aa;->a(Landroid/content/Context;Ljava/lang/Throwable;)V
    :try_end_8
...
.method public static onEvent(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/util/Map;)V
    ...
    invoke-interface {v0, p0, p1, p2, p3}, Lcom/tendcloud/tenddata/aa;->a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/util/Map;)V
    :try_end_8
    .catch Ljava/lang/Throwable; {:try_start_0 .. :try_end_8} :catch_9
...
.method public static onPageEnd(Landroid/content/Context;Ljava/lang/String;)V
    ...
    invoke-interface {v0, p0, p1}, Lcom/tendcloud/tenddata/aa;->onPageEnd(Landroid/content/Context;Ljava/lang/String;)V
    :try_end_8
    .catch Ljava/lang/Throwable; {:try_start_0 .. :try_end_8} :catch_9
...
.method public static onPageStart(Landroid/content/Context;Ljava/lang/String;)V
    ...
    invoke-interface {v0, p0, p1}, Lcom/tendcloud/tenddata/aa;->onPageStart(Landroid/content/Context;Ljava/lang/String;)V
    :try_end_8
    .catch Ljava/lang/Throwable; {:try_start_0 .. :try_end_8} :catch_9
...
.method public static onPause(Landroid/app/Activity;)V
    ...
    invoke-interface {v0, p0}, Lcom/tendcloud/tenddata/aa;->b(Landroid/app/Activity;)V
    :try_end_8
    .catch Ljava/lang/Throwable; {:try_start_0 .. :try_end_8} :catch_9
...
.method public static onResume(Landroid/app/Activity;)V
    ...
    invoke-interface {v0, p0}, Lcom/tendcloud/tenddata/aa;->a(Landroid/app/Activity;)V
    :try_end_8
    .catch Ljava/lang/Throwable; {:try_start_0 .. :try_end_8} :catch_9
...
.method public static onResume(Landroid/app/Activity;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-interface {v0, p0, p1, p2}, Lcom/tendcloud/tenddata/aa;->onResume(Landroid/app/Activity;Ljava/lang/String;Ljava/lang/String;)V
    :try_end_8
    .catch Ljava/lang/Throwable; {:try_start_0 .. :try_end_8} :catch_9
...
.method public static removeGlobalKV(Ljava/lang/String;)V
    ...
    :cond_1e
    sget-object v0, Lcom/tendcloud/tenddata/e;->a:Ljava/util/Map;
...
.method public static setReportUncaughtExceptions(Z)V
    ...
    :try_start_0
    sput-boolean p0, Lcom/tendcloud/tenddata/e;->b:Z
